...
# Agrega la ruta absoluta del directorio Logic a sys.path
sys.path.append("C:/Users/santy/Downloads/E2_HIPOTECA_INVERSA_/Logic")

# Ahora puedes importar los módulos de Logic directamente
import unittest
